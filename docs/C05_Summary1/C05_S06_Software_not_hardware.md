...
<!-- BELGIUM ONLY censored by Maria Girone <Maria.Girone@cern.ch> in the LUMI texts where this was first used. -->
??? Example "Case Study: Bringing CERN LHC computations to an HPC infrastructure."
    ...
    *[""Piz Daint" is slightly more cost-effective."](https://www.cscs.ch/science/physics/2019/piz-daint-takes-on-tier-2-function-in-worldwide-lhc-computing-grid).*
    ...
    at the scale of the full machine. This may not be a large issue for a Tier-2 system in the VSC
    (but it could be from a management point of view), 
