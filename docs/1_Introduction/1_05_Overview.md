...
there even earlier as 8-core Android smartphones have been around sincce 2013.
...
may harm the performance of a supercomputer and are not needed by real supercomptuer applications.
...
and energy cost, of supercomputers that are fully based on general-puropse hardware has become
too high to sustain the growth of compute capacity, scientists have turned into other technologies,
collectively known as accelerators, to futher increase the performance at a lower investment and
